...
class LoRAModule(pl.LightningModule):
    def __init__(self, hparams):
        ...
        # Lists for test predictions and labels
    ...
    def _load_hyperparameters(self):
        ...
        self.lora_alpha = hparams_source.get("lora_alpha", 16)
        self.lora_r = hparams_source.get("lora_r", 8)
        self.lora_dropout = hparams_source.get("lora_dropout", 0.1)
