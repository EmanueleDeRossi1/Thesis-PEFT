...
class BenchmarkDataModuleSourceTarget(pl.LightningDataModule):
    def __init__(
        self,
        ...
        """
        Use the torch Datasets to load Benchmark datasets
        hparams: Dict[str, Any]
        hyper-parameters for the classification data module
        the following keys shold be present in the dictionary:
        ----------
        dataset_cache_dir: str
            Folder name stores the Benchmark dataset downloaded from the web.
        ...
        super(BenchmarkDataModuleSourceTarget, self).__init__()
...
class SourceTargetDataset(Dataset):
    ...
    def __getitem__(self, index):
        pairs = self.source_df.iloc[index]["pairs"]
        ...
        pairs = self.target_df.iloc[index]["pairs"]
        encoded_input = self.tokenizer(
            str(pairs),
            max_length=self.max_seq_length,
            truncation=True,
